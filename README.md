About apache-flink-libraries-feedstock
======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-flink-libraries-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-flink-libraries-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-flink-libraries
# for installing globally
pixi global install apache-flink-libraries
```
...
It is possible to list all of the versions of `apache-flink-libraries` available on your platform:
...
```
pixi search apache-flink-libraries --channel conda-forge
```
